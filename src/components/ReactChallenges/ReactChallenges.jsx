      ...
      >
        <button
          style={{
            ...
            height: "80px",
            width: "80px",
            background: currentTask === "task1" ? "coral" : "white",
          }}
        ...
        <button
          style={{
            ...
            height: "80px",
            width: "80px",
            background: currentTask === "task2" ? "coral" : "white",
          }}
        ...
        <button
          style={{
            ...
            height: "80px",
            width: "80px",
            background: currentTask === "task3" ? "coral" : "white",
          }}
          onClick={() => handleTaskClick("task3")}
        >
          Task 3
        </button>
        <button
          style={{
            ...
            height: "80px",
            width: "80px",
            background: currentTask === "task4" ? "coral" : "white",
          }}
